...
const FooterCta = ({ showContact, onShowContact }) => {
                ...
                <div className="container">
                    <div className="row">
                        <div className="cta">
                            ...
                            <button className="btn btn-primary text-uppercase contact-us" onClick={!showContact ? onShowContact : null}>get a free quote </button>
                            </div>
                        </div>
                    </div>
                </div>
